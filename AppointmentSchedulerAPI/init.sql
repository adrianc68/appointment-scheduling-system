...
/*  Created On : 27-Dec-2024 1:05:07 AM 				*/
/*  DBMS       : PostgreSQL 						*/
/* ---------------------------------------------------- */
...
DROP SEQUENCE IF EXISTS assistantservice_id_seq
;
...
DROP TABLE IF EXISTS "AppointmentAssistantService" CASCADE
;
...
CREATE TYPE "AppointmentStatusType" AS ENUM ('SCHEDULED','CONFIRMED', 'CANCELED', 'FINISHED');
...
CREATE TABLE "AppointmentAssistantService"
(
	id_assistant_service integer NULL,
...
(
	...
	uuid uuid NULL,
	id integer NOT NULL   DEFAULT NEXTVAL(('"assistantservice_id_seq"'::text)::regclass)
)
;
...
CREATE INDEX "IXFK_AppointmentAssistantService_AssistantService" ON "AppointmentAssistantService" (id_assistant_service ASC)
;

CREATE INDEX "IXFK_AppointmentService_Appointment" ON "AppointmentAssistantService" (id_appointment ASC)
;
...
ALTER TABLE "AssistantService" ADD CONSTRAINT "PK_AssistantService"
	PRIMARY KEY (id)
;
...
ALTER TABLE "AppointmentAssistantService" ADD CONSTRAINT "FK_AppointmentAssistantService_AssistantService"
	FOREIGN KEY (id_assistant_service) REFERENCES "AssistantService" (id) ON DELETE Cascade ON UPDATE Cascade
;

ALTER TABLE "AppointmentAssistantService" ADD CONSTRAINT "FK_AppointmentService_Appointment"
...
CREATE SEQUENCE assistantservice_id_seq INCREMENT 1 START 1
;
