...
/*  Created On : 15-Jan-2025 2:16:43 PM 				*/
/*  DBMS       : PostgreSQL 						*/
/* ---------------------------------------------------- */
...
CREATE TYPE "NotificationCodeType" AS ENUM('APPOINTMENT_SCHEDULED', 'APPOINTMENT_RESCHEDULED', 'APPOINTMENT_CANCELED', 'APPOINTMENT_REMINDER', 'APPOINTMENT_CONFIRMED', 'SYSTEM_MAINTENANCE', 'NEW_FEATURE_ANNOUNCEMENT', 'GENERAL_ALERT', 'PAYMENT_PROCESSED', 'PAYMENT_FAILED', 'INVOICE_GENERATED', 'PROFILE_UPDATED', 'PASSWORD_CHANGE_REQUESTED', 'USER_ACCOUNT_DEACTIVATED', 'ERROR_NOTIFICATION');
...
(
	...
	message text NULL,
	code "NotificationCodeType" NULL,
...
CREATE INDEX "IXFK_NotificationBase_UserAccount" ON "NotificationBase" (id_user_account ASC)
;
...
ALTER TABLE "NotificationBase" ADD CONSTRAINT "FK_NotificationBase_UserAccount"
	FOREIGN KEY (id_user_account) REFERENCES "UserAccount" (id) ON DELETE Cascade ON UPDATE Cascade
;
