...
/*  Created On : 03-Jan-2025 1:32:43 AM 				*/
/*  DBMS       : PostgreSQL 						*/
/* ---------------------------------------------------- */
...
DROP TABLE IF EXISTS "AppointmentServiceOffer" CASCADE
;
...
CREATE TYPE "ServiceOfferStatusType" AS ENUM ('AVAILABLE', 'NOT_AVAILABLE');
...
CREATE TABLE "AppointmentServiceOffer"
(
...
CREATE INDEX "IXFK_AppointmentAssistantService_AssistantService" ON "AppointmentServiceOffer" ("id_serviceOffer" ASC)
;

CREATE INDEX "IXFK_AppointmentService_Appointment" ON "AppointmentServiceOffer" (id_appointment ASC)
;
...
ALTER TABLE "AppointmentServiceOffer" ADD CONSTRAINT "FK_AppointmentAssistantService_AssistantService"
	FOREIGN KEY ("id_serviceOffer") REFERENCES "ServiceOffer" (id) ON DELETE Cascade ON UPDATE Cascade
;

ALTER TABLE "AppointmentServiceOffer" ADD CONSTRAINT "FK_AppointmentService_Appointment"
