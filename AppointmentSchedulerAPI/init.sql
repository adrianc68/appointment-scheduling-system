...
/*  Created On : 17-Jan-2025 12:59:24 AM 				*/
/*  DBMS       : PostgreSQL 						*/
/* ---------------------------------------------------- */
...
CREATE TYPE "AppointmentNotificationCodeType" AS ENUM('APPOINTMENT_SCHEDULED', 'APPOINTMENT_TRESCHEDULED', 'APPOINTMENT_CANCELED', 'APPOINTMENT_REMINDER', 'APPOINTMENT_CONFIRMED');
